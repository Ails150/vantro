      ...
      <div className="px-6 py-6 max-w-6xl">
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-[#1a2635] border border-white/5 rounded-xl overflow-hidden">
              ...
              {alerts.length === 0 ? (
                <div className="px-5 py-8 text-center text-[#4d6478] text-sm">No alerts â€” all clear</div>
            ...
            <div className="bg-[#1a2635] border border-white/5 rounded-xl overflow-hidden col-span-2">
              ...
              {jobs.length === 0 ? (
                <div className="px-5 py-8 text-center text-[#4d6478] text-sm">No jobs yet â€” create one in the Jobs tab</div>
        ...
        {activeTab === 'alerts' && (
          <div className="bg-[#1a2635] border border-white/5 rounded-xl overflow-hidden">
            ...
            {alerts.length === 0 ? (
              <div className="px-5 py-12 text-center text-[#4d6478] text-sm">No alerts â€” all clear</div>
            ) : alerts.map((a: any) => (
              <div key={a.id} className="px-5 py-4 border-b border-white/5 last:border-0">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-xs text-[#4d6478] mb-1">{a.jobs?.name} Â· {new Date(a.created_at).toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit' })}</div>
                      <div className="text-sm">{a.message}</div>
                    </div>
                  </div>
                  <button
