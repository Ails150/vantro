      ...
      <div className="w-full max-w-xl">
        ...
        {step === 'installers' && (
          <div className="bg-[#1a2635] border border-white/5 rounded-2xl p-8">
            ...
            <div className="flex gap-3 mt-6">
              <button onClick={() => setStep('company')} className="flex-1 bg-[#243040] text-[#8fa3b8] font-medium rounded-xl py-3 text-sm">â† Back</button>
              <button
        ...
        {step === 'jobs' && (
          <div className="bg-[#1a2635] border border-white/5 rounded-2xl p-8">
            ...
            {error && <p className="text-red-400 text-sm bg-red-400/10 border border-red-400/20 rounded-lg px-4 py-3 mt-4">{error}</p>}
            <div className="flex gap-3 mt-6">
              <button onClick={() => setStep('installers')} className="flex-1 bg-[#243040] text-[#8fa3b8] font-medium rounded-xl py-3 text-sm">â† Back</button>
              <button
                onClick={saveJobs}
                disabled={loading}
                className="flex-2 bg-[#00d4a0] hover:bg-[#00a87e] disabled:opacity-40 text-[#0f1923] font-semibold rounded-xl py-3 text-sm transition-colors px-8"
              >
                {loading ? 'Saving...' : 'Finish setup â†’'}
              </button>
            </div>
          </div>
        )}
